...
MODULE mpi_f08
    ...
    INTERFACE MPI_Allgather
        ...
        SUBROUTINE MPI_Allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                             comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allgather_f08ts_large
    ...
    INTERFACE MPI_Allgather_init
        ...
        SUBROUTINE MPI_Allgather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allgather_init_f08ts_large
    ...
    INTERFACE MPI_Allgatherv
        ...
        SUBROUTINE MPI_Allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allgatherv_f08ts_large
    ...
    INTERFACE MPI_Allgatherv_init
        ...
        SUBROUTINE MPI_Allgatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allgatherv_init_f08ts_large
    ...
    INTERFACE MPI_Allreduce
        ...
        SUBROUTINE MPI_Allreduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allreduce_f08ts_large
    ...
    INTERFACE MPI_Allreduce_init
        ...
        SUBROUTINE MPI_Allreduce_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, &
                                                  request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Allreduce_init_f08ts_large
    ...
    INTERFACE MPI_Alltoall
        ...
        SUBROUTINE MPI_Alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                            comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoall_f08ts_large
    ...
    INTERFACE MPI_Alltoall_init
        ...
        SUBROUTINE MPI_Alltoall_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                                 comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoall_init_f08ts_large
    ...
    INTERFACE MPI_Alltoallv
        ...
        SUBROUTINE MPI_Alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoallv_f08ts_large
    ...
    INTERFACE MPI_Alltoallv_init
        ...
        SUBROUTINE MPI_Alltoallv_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoallv_init_f08ts_large
    ...
    INTERFACE MPI_Alltoallw
        ...
        SUBROUTINE MPI_Alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, &
                                             rdispls, recvtypes, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoallw_f08ts_large
    ...
    INTERFACE MPI_Alltoallw_init
        ...
        SUBROUTINE MPI_Alltoallw_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Alltoallw_init_f08ts_large
    ...
    INTERFACE MPI_Bcast
        ...
        SUBROUTINE MPI_Bcast_f08ts_large(buffer, count, datatype, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(inout) :: buffer
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Bcast_f08ts_large
    ...
    INTERFACE MPI_Bcast_init
        ...
        SUBROUTINE MPI_Bcast_init_f08ts_large(buffer, count, datatype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buffer
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Bcast_init_f08ts_large
    ...
    INTERFACE MPI_Exscan
        ...
        SUBROUTINE MPI_Exscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Exscan_f08ts_large
    ...
    INTERFACE MPI_Exscan_init
        ...
        SUBROUTINE MPI_Exscan_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, request, &
                                               ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Exscan_init_f08ts_large
    ...
    INTERFACE MPI_Gather
        ...
        SUBROUTINE MPI_Gather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                          comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Gather_f08ts_large
    ...
    INTERFACE MPI_Gather_init
        ...
        SUBROUTINE MPI_Gather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Gather_init_f08ts_large
    ...
    INTERFACE MPI_Gatherv
        ...
        SUBROUTINE MPI_Gatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Gatherv_f08ts_large
    ...
    INTERFACE MPI_Gatherv_init
        ...
        SUBROUTINE MPI_Gatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
                                                recvtype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Gatherv_init_f08ts_large
    ...
    INTERFACE MPI_Iallgather
        ...
        SUBROUTINE MPI_Iallgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                              comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iallgather_f08ts_large
    ...
    INTERFACE MPI_Iallgatherv
        ...
        SUBROUTINE MPI_Iallgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
                                               recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iallgatherv_f08ts_large
    ...
    INTERFACE MPI_Iallreduce
        ...
        SUBROUTINE MPI_Iallreduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iallreduce_f08ts_large
    ...
    INTERFACE MPI_Ialltoall
        ...
        SUBROUTINE MPI_Ialltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                             comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ialltoall_f08ts_large
    ...
    INTERFACE MPI_Ialltoallv
        ...
        SUBROUTINE MPI_Ialltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, &
                                              rdispls, recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ialltoallv_f08ts_large
    ...
    INTERFACE MPI_Ialltoallw
        ...
        SUBROUTINE MPI_Ialltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, &
                                              rdispls, recvtypes, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ialltoallw_f08ts_large
    ...
    INTERFACE MPI_Ibcast
        ...
        SUBROUTINE MPI_Ibcast_f08ts_large(buffer, count, datatype, root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(inout), ASYNCHRONOUS :: buffer
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ibcast_f08ts_large
    ...
    INTERFACE MPI_Iexscan
        ...
        SUBROUTINE MPI_Iexscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iexscan_f08ts_large
    ...
    INTERFACE MPI_Igather
        ...
        SUBROUTINE MPI_Igather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                           comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Igather_f08ts_large
    ...
    INTERFACE MPI_Igatherv
        ...
        SUBROUTINE MPI_Igatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Igatherv_f08ts_large
    ...
    INTERFACE MPI_Ineighbor_allgather
        ...
        SUBROUTINE MPI_Ineighbor_allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                       recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ineighbor_allgather_f08ts_large
    ...
    INTERFACE MPI_Ineighbor_allgatherv
        ...
        SUBROUTINE MPI_Ineighbor_allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ineighbor_allgatherv_f08ts_large
    ...
    INTERFACE MPI_Ineighbor_alltoall
        ...
        SUBROUTINE MPI_Ineighbor_alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                      recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ineighbor_alltoall_f08ts_large
    ...
    INTERFACE MPI_Ineighbor_alltoallv
        ...
        SUBROUTINE MPI_Ineighbor_alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ineighbor_alltoallv_f08ts_large
    ...
    INTERFACE MPI_Ineighbor_alltoallw
        ...
        SUBROUTINE MPI_Ineighbor_alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ineighbor_alltoallw_f08ts_large
    ...
    INTERFACE MPI_Ireduce
        ...
        SUBROUTINE MPI_Ireduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, request, &
                                           ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ireduce_f08ts_large
    ...
    INTERFACE MPI_Ireduce_scatter
        ...
        SUBROUTINE MPI_Ireduce_scatter_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, &
                                                   request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ireduce_scatter_f08ts_large
    ...
    INTERFACE MPI_Ireduce_scatter_block
        ...
        SUBROUTINE MPI_Ireduce_scatter_block_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, comm, &
                                                         request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ireduce_scatter_block_f08ts_large
    ...
    INTERFACE MPI_Iscan
        ...
        SUBROUTINE MPI_Iscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iscan_f08ts_large
    ...
    INTERFACE MPI_Iscatter
        ...
        SUBROUTINE MPI_Iscatter_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                            root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iscatter_f08ts_large
    ...
    INTERFACE MPI_Iscatterv
        ...
        SUBROUTINE MPI_Iscatterv_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                             recvtype, root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Iscatterv_f08ts_large
    ...
    INTERFACE MPI_Neighbor_allgather
        ...
        SUBROUTINE MPI_Neighbor_allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                      recvtype, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_allgather_f08ts_large
    ...
    INTERFACE MPI_Neighbor_allgather_init
        ...
        SUBROUTINE MPI_Neighbor_allgather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                           recvtype, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_allgather_init_f08ts_large
    ...
    INTERFACE MPI_Neighbor_allgatherv
        ...
        SUBROUTINE MPI_Neighbor_allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_allgatherv_f08ts_large
    ...
    INTERFACE MPI_Neighbor_allgatherv_init
        ...
        SUBROUTINE MPI_Neighbor_allgatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_allgatherv_init_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoall
        ...
        SUBROUTINE MPI_Neighbor_alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                     recvtype, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoall_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoall_init
        ...
        SUBROUTINE MPI_Neighbor_alltoall_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                          recvtype, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoall_init_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoallv
        ...
        SUBROUTINE MPI_Neighbor_alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoallv_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoallv_init
        ...
        SUBROUTINE MPI_Neighbor_alltoallv_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoallv_init_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoallw
        ...
        SUBROUTINE MPI_Neighbor_alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
                                                      recvcounts, rdispls, recvtypes, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoallw_f08ts_large
    ...
    INTERFACE MPI_Neighbor_alltoallw_init
        ...
        SUBROUTINE MPI_Neighbor_alltoallw_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Neighbor_alltoallw_init_f08ts_large
    ...
    INTERFACE MPI_Reduce
        ...
        SUBROUTINE MPI_Reduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_f08ts_large
    ...
    INTERFACE MPI_Reduce_init
        ...
        SUBROUTINE MPI_Reduce_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, info, &
                                               request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_init_f08ts_large
    ...
    INTERFACE MPI_Reduce_local
        ...
        SUBROUTINE MPI_Reduce_local_f08ts_large(inbuf, inoutbuf, count, datatype, op, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: inbuf
            ...
            TYPE(MPI_Op), INTENT(in) :: op
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_local_f08ts_large
    ...
    INTERFACE MPI_Reduce_scatter
        ...
        SUBROUTINE MPI_Reduce_scatter_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_scatter_f08ts_large
    ...
    INTERFACE MPI_Reduce_scatter_block
        ...
        SUBROUTINE MPI_Reduce_scatter_block_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, comm, &
                                                        ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_scatter_block_f08ts_large
    ...
    INTERFACE MPI_Reduce_scatter_block_init
        ...
        SUBROUTINE MPI_Reduce_scatter_block_init_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, &
                                                             comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_scatter_block_init_f08ts_large
    ...
    INTERFACE MPI_Reduce_scatter_init
        ...
        SUBROUTINE MPI_Reduce_scatter_init_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, &
                                                       info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Reduce_scatter_init_f08ts_large
    ...
    INTERFACE MPI_Scan
        ...
        SUBROUTINE MPI_Scan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scan_f08ts_large
    ...
    INTERFACE MPI_Scan_init
        ...
        SUBROUTINE MPI_Scan_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, request, &
                                             ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scan_init_f08ts_large
    ...
    INTERFACE MPI_Scatter
        ...
        SUBROUTINE MPI_Scatter_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                           comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scatter_f08ts_large
    ...
    INTERFACE MPI_Scatter_init
        ...
        SUBROUTINE MPI_Scatter_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                                root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scatter_init_f08ts_large
    ...
    INTERFACE MPI_Scatterv
        ...
        SUBROUTINE MPI_Scatterv_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                            recvtype, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scatterv_f08ts_large
    ...
    INTERFACE MPI_Scatterv_init
        ...
        SUBROUTINE MPI_Scatterv_init_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                                 recvtype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Scatterv_init_f08ts_large
    ...
    INTERFACE MPI_Get_count
        ...
        SUBROUTINE MPI_Get_count_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(in), TARGET :: status
            ...
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Get_count_f08_large
    ...
    INTERFACE MPI_Get_elements
        ...
        SUBROUTINE MPI_Get_elements_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(in), TARGET :: status
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: count
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Get_elements_f08_large
    ...
    INTERFACE MPI_Pack
        ...
        SUBROUTINE MPI_Pack_f08ts_large(inbuf, incount, datatype, outbuf, outsize, position, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: inbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Pack_f08ts_large
    ...
    INTERFACE MPI_Pack_external
        ...
        SUBROUTINE MPI_Pack_external_f08ts_large(datarep, inbuf, incount, datatype, outbuf, outsize, &
                                                 position, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(inout) :: position
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Pack_external_f08ts_large
    ...
    INTERFACE MPI_Pack_external_size
        ...
        SUBROUTINE MPI_Pack_external_size_f08_large(datarep, incount, datatype, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            CHARACTER(len=*), INTENT(in) :: datarep
            ...
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Pack_external_size_f08_large
    ...
    INTERFACE MPI_Pack_size
        ...
        SUBROUTINE MPI_Pack_size_f08_large(incount, datatype, comm, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: incount
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Pack_size_f08_large
    ...
    INTERFACE MPI_Status_set_elements
        ...
        SUBROUTINE MPI_Status_set_elements_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(inout), TARGET :: status
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Status_set_elements_f08_large
    ...
    INTERFACE MPI_Type_contiguous
        ...
        SUBROUTINE MPI_Type_contiguous_f08_large(count, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_contiguous_f08_large
    ...
    INTERFACE MPI_Type_create_darray
        ...
        SUBROUTINE MPI_Type_create_darray_f08_large(size, rank, ndims, array_of_gsizes, array_of_distribs, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_darray_f08_large
    ...
    INTERFACE MPI_Type_create_hindexed
        ...
        SUBROUTINE MPI_Type_create_hindexed_f08_large(count, array_of_blocklengths, array_of_displacements, &
                                                      oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_hindexed_f08_large
    ...
    INTERFACE MPI_Type_create_hindexed_block
        ...
        SUBROUTINE MPI_Type_create_hindexed_block_f08_large(count, blocklength, array_of_displacements, &
                                                            oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_hindexed_block_f08_large
    ...
    INTERFACE MPI_Type_create_hvector
        ...
        SUBROUTINE MPI_Type_create_hvector_f08_large(count, blocklength, stride, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_hvector_f08_large
    ...
    INTERFACE MPI_Type_create_indexed_block
        ...
        SUBROUTINE MPI_Type_create_indexed_block_f08_large(count, blocklength, array_of_displacements, &
                                                           oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_indexed_block_f08_large
    ...
    INTERFACE MPI_Type_create_struct
        ...
        SUBROUTINE MPI_Type_create_struct_f08_large(count, array_of_blocklengths, array_of_displacements, &
                                                    array_of_types, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_struct_f08_large
    ...
    INTERFACE MPI_Type_create_subarray
        ...
        SUBROUTINE MPI_Type_create_subarray_f08_large(ndims, array_of_sizes, array_of_subsizes, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_create_subarray_f08_large
    ...
    INTERFACE MPI_Type_get_contents
        ...
        SUBROUTINE MPI_Type_get_contents_f08_large(datatype, max_integers, max_addresses, max_large_counts, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: array_of_datatypes(max_datatypes)
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_get_contents_f08_large
    ...
    INTERFACE MPI_Type_get_envelope
        ...
        SUBROUTINE MPI_Type_get_envelope_f08_large(datatype, num_integers, num_addresses, num_large_counts, &
            ...
            INTEGER, INTENT(out) :: combiner
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_get_envelope_f08_large
    ...
    INTERFACE MPI_Type_indexed
        ...
        SUBROUTINE MPI_Type_indexed_f08_large(count, array_of_blocklengths, array_of_displacements, oldtype, &
                                              newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_indexed_f08_large
    ...
    INTERFACE MPI_Type_size
        ...
        SUBROUTINE MPI_Type_size_f08_large(datatype, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_size_f08_large
    ...
    INTERFACE MPI_Type_vector
        ...
        SUBROUTINE MPI_Type_vector_f08_large(count, blocklength, stride, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Type_vector_f08_large
    ...
    INTERFACE MPI_Unpack
        ...
        SUBROUTINE MPI_Unpack_f08ts_large(inbuf, insize, position, outbuf, outcount, datatype, comm, &
                                          ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Unpack_f08ts_large
    ...
    INTERFACE MPI_Unpack_external
        ...
        SUBROUTINE MPI_Unpack_external_f08ts_large(datarep, inbuf, insize, position, outbuf, outcount, &
                                                   datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Unpack_external_f08ts_large
    ...
    INTERFACE MPI_Op_create_c
        SUBROUTINE MPI_Op_create_f08_large(user_fn, commute, op, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Op
            ...
            TYPE(MPI_Op), INTENT(out) :: op
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Op_create_f08_large
    ...
    INTERFACE MPI_Bsend
        ...
        SUBROUTINE MPI_Bsend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Bsend_f08ts_large
    ...
    INTERFACE MPI_Bsend_init
        ...
        SUBROUTINE MPI_Bsend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Bsend_init_f08ts_large
    ...
    INTERFACE MPI_Buffer_attach
        ...
        SUBROUTINE MPI_Buffer_attach_f08ts_large(buffer, size, ierror)
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buffer
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Buffer_attach_f08ts_large
    ...
    INTERFACE MPI_Buffer_detach
        ...
        SUBROUTINE MPI_Buffer_detach_f08_large(buffer_addr, size, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(C_PTR), INTENT(out) :: buffer_addr
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Buffer_detach_f08_large
    ...
    INTERFACE MPI_Ibsend
        ...
        SUBROUTINE MPI_Ibsend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ibsend_f08ts_large
    ...
    INTERFACE MPI_Imrecv
        ...
        SUBROUTINE MPI_Imrecv_f08ts_large(buf, count, datatype, message, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Message, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Imrecv_f08ts_large
    ...
    INTERFACE MPI_Irecv
        ...
        SUBROUTINE MPI_Irecv_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Irecv_f08ts_large
    ...
    INTERFACE MPI_Irsend
        ...
        SUBROUTINE MPI_Irsend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Irsend_f08ts_large
    ...
    INTERFACE MPI_Isend
        ...
        SUBROUTINE MPI_Isend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Isend_f08ts_large
    ...
    INTERFACE MPI_Isendrecv
        ...
        SUBROUTINE MPI_Isendrecv_f08ts_large(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Isendrecv_f08ts_large
    ...
    INTERFACE MPI_Isendrecv_replace
        ...
        SUBROUTINE MPI_Isendrecv_replace_f08ts_large(buf, count, datatype, dest, sendtag, source, recvtag, &
                                                     comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Isendrecv_replace_f08ts_large
    ...
    INTERFACE MPI_Issend
        ...
        SUBROUTINE MPI_Issend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Issend_f08ts_large
    ...
    INTERFACE MPI_Mrecv
        ...
        SUBROUTINE MPI_Mrecv_f08ts_large(buf, count, datatype, message, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Message, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Mrecv_f08ts_large
    ...
    INTERFACE MPI_Recv
        ...
        SUBROUTINE MPI_Recv_f08ts_large(buf, count, datatype, source, tag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Recv_f08ts_large
    ...
    INTERFACE MPI_Recv_init
        ...
        SUBROUTINE MPI_Recv_init_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Recv_init_f08ts_large
    ...
    INTERFACE MPI_Rsend
        ...
        SUBROUTINE MPI_Rsend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Rsend_f08ts_large
    ...
    INTERFACE MPI_Rsend_init
        ...
        SUBROUTINE MPI_Rsend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Rsend_init_f08ts_large
    ...
    INTERFACE MPI_Send_init
        ...
        SUBROUTINE MPI_Send_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Send_init_f08ts_large
    ...
    INTERFACE MPI_Sendrecv
        ...
        SUBROUTINE MPI_Sendrecv_f08ts_large(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, &
                                            recvtype, source, recvtag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Sendrecv_f08ts_large
    ...
    INTERFACE MPI_Sendrecv_replace
        ...
        SUBROUTINE MPI_Sendrecv_replace_f08ts_large(buf, count, datatype, dest, sendtag, source, recvtag, &
                                                    comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Sendrecv_replace_f08ts_large
    ...
    INTERFACE MPI_Ssend
        ...
        SUBROUTINE MPI_Ssend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ssend_f08ts_large
    ...
    INTERFACE MPI_Ssend_init
        ...
        SUBROUTINE MPI_Ssend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Ssend_init_f08ts_large
    ...
    INTERFACE MPI_Accumulate
        ...
        SUBROUTINE MPI_Accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                              target_disp, target_count, target_datatype, op, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Accumulate_f08ts_large
    ...
    INTERFACE MPI_Get
        ...
        SUBROUTINE MPI_Get_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, target_disp, &
                                       target_count, target_datatype, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Get_f08ts_large
    ...
    INTERFACE MPI_Get_accumulate
        ...
        SUBROUTINE MPI_Get_accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, result_addr, &
                                                  result_count, result_datatype, target_rank, target_disp, &
                                                  target_count, target_datatype, op, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Get_accumulate_f08ts_large
    ...
    INTERFACE MPI_Put
        ...
        SUBROUTINE MPI_Put_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, target_disp, &
                                       target_count, target_datatype, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Put_f08ts_large
    ...
    INTERFACE MPI_Raccumulate
        ...
        SUBROUTINE MPI_Raccumulate_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                               target_disp, target_count, target_datatype, op, win, request, &
                                               ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Raccumulate_f08ts_large
    ...
    INTERFACE MPI_Rget
        ...
        SUBROUTINE MPI_Rget_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Rget_f08ts_large
    ...
    INTERFACE MPI_Rget_accumulate
        ...
        SUBROUTINE MPI_Rget_accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, result_addr, &
                                                   result_count, result_datatype, target_rank, target_disp, &
                                                   target_count, target_datatype, op, win, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Rget_accumulate_f08ts_large
    ...
    INTERFACE MPI_Rput
        ...
        SUBROUTINE MPI_Rput_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                        target_disp, target_count, target_datatype, win, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Rput_f08ts_large
    ...
    INTERFACE MPI_Win_allocate
        ...
        SUBROUTINE MPI_Win_allocate_f08_large(size, disp_unit, info, comm, baseptr, win, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Win_allocate_f08_large
    ...
    INTERFACE MPI_Win_allocate_shared
        ...
        SUBROUTINE MPI_Win_allocate_shared_f08_large(size, disp_unit, info, comm, baseptr, win, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Win_allocate_shared_f08_large
    ...
    INTERFACE MPI_Win_create
        ...
        SUBROUTINE MPI_Win_create_f08ts_large(base, size, disp_unit, info, comm, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: base
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Win_create_f08ts_large
    ...
    INTERFACE MPI_Win_shared_query
        ...
        SUBROUTINE MPI_Win_shared_query_f08_large(win, rank, size, disp_unit, baseptr, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(C_PTR), INTENT(out) :: baseptr
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Win_shared_query_f08_large
    ...
    INTERFACE MPIX_Stream_send
        ...
        SUBROUTINE MPIX_Stream_send_f08ts_large(buf, count, datatype, dest, tag, comm, source_stream_index, &
                                                dest_stream_index, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            INTEGER, INTENT(in) :: dest_stream_index
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Stream_send_f08ts_large
    ...
    INTERFACE MPIX_Stream_isend
        ...
        SUBROUTINE MPIX_Stream_isend_f08ts_large(buf, count, datatype, dest, tag, comm, source_stream_index, &
                                                 dest_stream_index, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Stream_isend_f08ts_large
    ...
    INTERFACE MPIX_Stream_recv
        ...
        SUBROUTINE MPIX_Stream_recv_f08ts_large(buf, count, datatype, source, tag, comm, &
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Stream_recv_f08ts_large
    ...
    INTERFACE MPIX_Stream_irecv
        ...
        SUBROUTINE MPIX_Stream_irecv_f08ts_large(buf, count, datatype, source, tag, comm, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Stream_irecv_f08ts_large
    ...
    INTERFACE MPIX_Send_enqueue
        ...
        SUBROUTINE MPIX_Send_enqueue_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Send_enqueue_f08ts_large
    ...
    INTERFACE MPIX_Recv_enqueue
        ...
        SUBROUTINE MPIX_Recv_enqueue_f08ts_large(buf, count, datatype, source, tag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Recv_enqueue_f08ts_large
    ...
    INTERFACE MPIX_Isend_enqueue
        ...
        SUBROUTINE MPIX_Isend_enqueue_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Isend_enqueue_f08ts_large
    ...
    INTERFACE MPIX_Irecv_enqueue
        ...
        SUBROUTINE MPIX_Irecv_enqueue_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Irecv_enqueue_f08ts_large
    ...
    INTERFACE MPIX_Allreduce_enqueue
        ...
        SUBROUTINE MPIX_Allreduce_enqueue_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPIX_Allreduce_enqueue_f08ts_large
    ...
    INTERFACE MPI_File_iread
        ...
        SUBROUTINE MPI_File_iread_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iread_f08ts_large
    ...
    INTERFACE MPI_File_iread_all
        ...
        SUBROUTINE MPI_File_iread_all_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iread_all_f08ts_large
    ...
    INTERFACE MPI_File_iread_at
        ...
        SUBROUTINE MPI_File_iread_at_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iread_at_f08ts_large
    ...
    INTERFACE MPI_File_iread_at_all
        ...
        SUBROUTINE MPI_File_iread_at_all_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iread_at_all_f08ts_large
    ...
    INTERFACE MPI_File_iread_shared
        ...
        SUBROUTINE MPI_File_iread_shared_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iread_shared_f08ts_large
    ...
    INTERFACE MPI_File_iwrite
        ...
        SUBROUTINE MPI_File_iwrite_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iwrite_f08ts_large
    ...
    INTERFACE MPI_File_iwrite_all
        ...
        SUBROUTINE MPI_File_iwrite_all_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iwrite_all_f08ts_large
    ...
    INTERFACE MPI_File_iwrite_at
        ...
        SUBROUTINE MPI_File_iwrite_at_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iwrite_at_f08ts_large
    ...
    INTERFACE MPI_File_iwrite_at_all
        ...
        SUBROUTINE MPI_File_iwrite_at_all_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iwrite_at_all_f08ts_large
    ...
    INTERFACE MPI_File_iwrite_shared
        ...
        SUBROUTINE MPI_File_iwrite_shared_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_iwrite_shared_f08ts_large
    ...
    INTERFACE MPI_File_read
        ...
        SUBROUTINE MPI_File_read_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_f08ts_large
    ...
    INTERFACE MPI_File_read_all
        ...
        SUBROUTINE MPI_File_read_all_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_all_f08ts_large
    ...
    INTERFACE MPI_File_read_all_begin
        ...
        SUBROUTINE MPI_File_read_all_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_all_begin_f08ts_large
    ...
    INTERFACE MPI_File_read_at
        ...
        SUBROUTINE MPI_File_read_at_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_at_f08ts_large
    ...
    INTERFACE MPI_File_read_at_all
        ...
        SUBROUTINE MPI_File_read_at_all_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_at_all_f08ts_large
    ...
    INTERFACE MPI_File_read_at_all_begin
        ...
        SUBROUTINE MPI_File_read_at_all_begin_f08ts_large(fh, offset, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_at_all_begin_f08ts_large
    ...
    INTERFACE MPI_File_read_ordered
        ...
        SUBROUTINE MPI_File_read_ordered_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_ordered_f08ts_large
    ...
    INTERFACE MPI_File_read_ordered_begin
        ...
        SUBROUTINE MPI_File_read_ordered_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_ordered_begin_f08ts_large
    ...
    INTERFACE MPI_File_read_shared
        ...
        SUBROUTINE MPI_File_read_shared_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_read_shared_f08ts_large
    ...
    INTERFACE MPI_File_write
        ...
        SUBROUTINE MPI_File_write_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_f08ts_large
    ...
    INTERFACE MPI_File_write_all
        ...
        SUBROUTINE MPI_File_write_all_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_all_f08ts_large
    ...
    INTERFACE MPI_File_write_all_begin
        ...
        SUBROUTINE MPI_File_write_all_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_all_begin_f08ts_large
    ...
    INTERFACE MPI_File_write_at
        ...
        SUBROUTINE MPI_File_write_at_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_at_f08ts_large
    ...
    INTERFACE MPI_File_write_at_all
        ...
        SUBROUTINE MPI_File_write_at_all_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_at_all_f08ts_large
    ...
    INTERFACE MPI_File_write_at_all_begin
        ...
        SUBROUTINE MPI_File_write_at_all_begin_f08ts_large(fh, offset, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_at_all_begin_f08ts_large
    ...
    INTERFACE MPI_File_write_ordered
        ...
        SUBROUTINE MPI_File_write_ordered_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_ordered_f08ts_large
    ...
    INTERFACE MPI_File_write_ordered_begin
        ...
        SUBROUTINE MPI_File_write_ordered_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_ordered_begin_f08ts_large
    ...
    INTERFACE MPI_File_write_shared
        ...
        SUBROUTINE MPI_File_write_shared_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_File_write_shared_f08ts_large
    ...
    INTERFACE MPI_Register_datarep_c
        SUBROUTINE MPI_Register_datarep_f08_large(datarep, read_conversion_fn, write_conversion_fn, &
                                                  dtype_file_extent_fn, extra_state, ierror)
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            ...
            INTEGER(KIND=MPI_ADDRESS_KIND), INTENT(in) :: extra_state
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE MPI_Register_datarep_f08_large
