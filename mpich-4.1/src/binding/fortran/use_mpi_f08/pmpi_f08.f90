...
MODULE pmpi_f08
    ...
    INTERFACE PMPI_Allgather
        ...
        SUBROUTINE PMPIR_Allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                             comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allgather_f08ts_large
    ...
    INTERFACE PMPI_Allgather_init
        ...
        SUBROUTINE PMPIR_Allgather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allgather_init_f08ts_large
    ...
    INTERFACE PMPI_Allgatherv
        ...
        SUBROUTINE PMPIR_Allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allgatherv_f08ts_large
    ...
    INTERFACE PMPI_Allgatherv_init
        ...
        SUBROUTINE PMPIR_Allgatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allgatherv_init_f08ts_large
    ...
    INTERFACE PMPI_Allreduce
        ...
        SUBROUTINE PMPIR_Allreduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allreduce_f08ts_large
    ...
    INTERFACE PMPI_Allreduce_init
        ...
        SUBROUTINE PMPIR_Allreduce_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, &
                                                  request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Allreduce_init_f08ts_large
    ...
    INTERFACE PMPI_Alltoall
        ...
        SUBROUTINE PMPIR_Alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                            comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoall_f08ts_large
    ...
    INTERFACE PMPI_Alltoall_init
        ...
        SUBROUTINE PMPIR_Alltoall_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                                 comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoall_init_f08ts_large
    ...
    INTERFACE PMPI_Alltoallv
        ...
        SUBROUTINE PMPIR_Alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoallv_f08ts_large
    ...
    INTERFACE PMPI_Alltoallv_init
        ...
        SUBROUTINE PMPIR_Alltoallv_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoallv_init_f08ts_large
    ...
    INTERFACE PMPI_Alltoallw
        ...
        SUBROUTINE PMPIR_Alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, &
                                             rdispls, recvtypes, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoallw_f08ts_large
    ...
    INTERFACE PMPI_Alltoallw_init
        ...
        SUBROUTINE PMPIR_Alltoallw_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Alltoallw_init_f08ts_large
    ...
    INTERFACE PMPI_Bcast
        ...
        SUBROUTINE PMPIR_Bcast_f08ts_large(buffer, count, datatype, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(inout) :: buffer
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Bcast_f08ts_large
    ...
    INTERFACE PMPI_Bcast_init
        ...
        SUBROUTINE PMPIR_Bcast_init_f08ts_large(buffer, count, datatype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buffer
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Bcast_init_f08ts_large
    ...
    INTERFACE PMPI_Exscan
        ...
        SUBROUTINE PMPIR_Exscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Exscan_f08ts_large
    ...
    INTERFACE PMPI_Exscan_init
        ...
        SUBROUTINE PMPIR_Exscan_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, request, &
                                               ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Exscan_init_f08ts_large
    ...
    INTERFACE PMPI_Gather
        ...
        SUBROUTINE PMPIR_Gather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                          comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Gather_f08ts_large
    ...
    INTERFACE PMPI_Gather_init
        ...
        SUBROUTINE PMPIR_Gather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Gather_init_f08ts_large
    ...
    INTERFACE PMPI_Gatherv
        ...
        SUBROUTINE PMPIR_Gatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Gatherv_f08ts_large
    ...
    INTERFACE PMPI_Gatherv_init
        ...
        SUBROUTINE PMPIR_Gatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
                                                recvtype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Gatherv_init_f08ts_large
    ...
    INTERFACE PMPI_Iallgather
        ...
        SUBROUTINE PMPIR_Iallgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                              comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iallgather_f08ts_large
    ...
    INTERFACE PMPI_Iallgatherv
        ...
        SUBROUTINE PMPIR_Iallgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
                                               recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iallgatherv_f08ts_large
    ...
    INTERFACE PMPI_Iallreduce
        ...
        SUBROUTINE PMPIR_Iallreduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iallreduce_f08ts_large
    ...
    INTERFACE PMPI_Ialltoall
        ...
        SUBROUTINE PMPIR_Ialltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                             comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ialltoall_f08ts_large
    ...
    INTERFACE PMPI_Ialltoallv
        ...
        SUBROUTINE PMPIR_Ialltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, &
                                              rdispls, recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ialltoallv_f08ts_large
    ...
    INTERFACE PMPI_Ialltoallw
        ...
        SUBROUTINE PMPIR_Ialltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, &
                                              rdispls, recvtypes, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ialltoallw_f08ts_large
    ...
    INTERFACE PMPI_Ibcast
        ...
        SUBROUTINE PMPIR_Ibcast_f08ts_large(buffer, count, datatype, root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(inout), ASYNCHRONOUS :: buffer
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ibcast_f08ts_large
    ...
    INTERFACE PMPI_Iexscan
        ...
        SUBROUTINE PMPIR_Iexscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iexscan_f08ts_large
    ...
    INTERFACE PMPI_Igather
        ...
        SUBROUTINE PMPIR_Igather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                           comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Igather_f08ts_large
    ...
    INTERFACE PMPI_Igatherv
        ...
        SUBROUTINE PMPIR_Igatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Igatherv_f08ts_large
    ...
    INTERFACE PMPI_Ineighbor_allgather
        ...
        SUBROUTINE PMPIR_Ineighbor_allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                       recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ineighbor_allgather_f08ts_large
    ...
    INTERFACE PMPI_Ineighbor_allgatherv
        ...
        SUBROUTINE PMPIR_Ineighbor_allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ineighbor_allgatherv_f08ts_large
    ...
    INTERFACE PMPI_Ineighbor_alltoall
        ...
        SUBROUTINE PMPIR_Ineighbor_alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                      recvtype, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ineighbor_alltoall_f08ts_large
    ...
    INTERFACE PMPI_Ineighbor_alltoallv
        ...
        SUBROUTINE PMPIR_Ineighbor_alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ineighbor_alltoallv_f08ts_large
    ...
    INTERFACE PMPI_Ineighbor_alltoallw
        ...
        SUBROUTINE PMPIR_Ineighbor_alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ineighbor_alltoallw_f08ts_large
    ...
    INTERFACE PMPI_Ireduce
        ...
        SUBROUTINE PMPIR_Ireduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, request, &
                                           ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ireduce_f08ts_large
    ...
    INTERFACE PMPI_Ireduce_scatter
        ...
        SUBROUTINE PMPIR_Ireduce_scatter_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, &
                                                   request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ireduce_scatter_f08ts_large
    ...
    INTERFACE PMPI_Ireduce_scatter_block
        ...
        SUBROUTINE PMPIR_Ireduce_scatter_block_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, comm, &
                                                         request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ireduce_scatter_block_f08ts_large
    ...
    INTERFACE PMPI_Iscan
        ...
        SUBROUTINE PMPIR_Iscan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: sendbuf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iscan_f08ts_large
    ...
    INTERFACE PMPI_Iscatter
        ...
        SUBROUTINE PMPIR_Iscatter_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                            root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iscatter_f08ts_large
    ...
    INTERFACE PMPI_Iscatterv
        ...
        SUBROUTINE PMPIR_Iscatterv_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                             recvtype, root, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Iscatterv_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_allgather
        ...
        SUBROUTINE PMPIR_Neighbor_allgather_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                      recvtype, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_allgather_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_allgather_init
        ...
        SUBROUTINE PMPIR_Neighbor_allgather_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                           recvtype, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_allgather_init_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_allgatherv
        ...
        SUBROUTINE PMPIR_Neighbor_allgatherv_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcounts, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_allgatherv_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_allgatherv_init
        ...
        SUBROUTINE PMPIR_Neighbor_allgatherv_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_allgatherv_init_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoall
        ...
        SUBROUTINE PMPIR_Neighbor_alltoall_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                     recvtype, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoall_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoall_init
        ...
        SUBROUTINE PMPIR_Neighbor_alltoall_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, &
                                                          recvtype, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoall_init_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoallv
        ...
        SUBROUTINE PMPIR_Neighbor_alltoallv_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoallv_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoallv_init
        ...
        SUBROUTINE PMPIR_Neighbor_alltoallv_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtype, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoallv_init_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoallw
        ...
        SUBROUTINE PMPIR_Neighbor_alltoallw_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
                                                      recvcounts, rdispls, recvtypes, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoallw_f08ts_large
    ...
    INTERFACE PMPI_Neighbor_alltoallw_init
        ...
        SUBROUTINE PMPIR_Neighbor_alltoallw_init_f08ts_large(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Neighbor_alltoallw_init_f08ts_large
    ...
    INTERFACE PMPI_Reduce
        ...
        SUBROUTINE PMPIR_Reduce_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_f08ts_large
    ...
    INTERFACE PMPI_Reduce_init
        ...
        SUBROUTINE PMPIR_Reduce_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, root, comm, info, &
                                               request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_init_f08ts_large
    ...
    INTERFACE PMPI_Reduce_local
        ...
        SUBROUTINE PMPIR_Reduce_local_f08ts_large(inbuf, inoutbuf, count, datatype, op, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: inbuf
            ...
            TYPE(MPI_Op), INTENT(in) :: op
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_local_f08ts_large
    ...
    INTERFACE PMPI_Reduce_scatter
        ...
        SUBROUTINE PMPIR_Reduce_scatter_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_scatter_f08ts_large
    ...
    INTERFACE PMPI_Reduce_scatter_block
        ...
        SUBROUTINE PMPIR_Reduce_scatter_block_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, comm, &
                                                        ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_scatter_block_f08ts_large
    ...
    INTERFACE PMPI_Reduce_scatter_block_init
        ...
        SUBROUTINE PMPIR_Reduce_scatter_block_init_f08ts_large(sendbuf, recvbuf, recvcount, datatype, op, &
                                                             comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_scatter_block_init_f08ts_large
    ...
    INTERFACE PMPI_Reduce_scatter_init
        ...
        SUBROUTINE PMPIR_Reduce_scatter_init_f08ts_large(sendbuf, recvbuf, recvcounts, datatype, op, comm, &
                                                       info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Reduce_scatter_init_f08ts_large
    ...
    INTERFACE PMPI_Scan
        ...
        SUBROUTINE PMPIR_Scan_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scan_f08ts_large
    ...
    INTERFACE PMPI_Scan_init
        ...
        SUBROUTINE PMPIR_Scan_init_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, info, request, &
                                             ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scan_init_f08ts_large
    ...
    INTERFACE PMPI_Scatter
        ...
        SUBROUTINE PMPIR_Scatter_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, &
                                           comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scatter_f08ts_large
    ...
    INTERFACE PMPI_Scatter_init
        ...
        SUBROUTINE PMPIR_Scatter_init_f08ts_large(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, &
                                                root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scatter_init_f08ts_large
    ...
    INTERFACE PMPI_Scatterv
        ...
        SUBROUTINE PMPIR_Scatterv_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                            recvtype, root, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scatterv_f08ts_large
    ...
    INTERFACE PMPI_Scatterv_init
        ...
        SUBROUTINE PMPIR_Scatterv_init_f08ts_large(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, &
                                                 recvtype, root, comm, info, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Info, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Scatterv_init_f08ts_large
    ...
    INTERFACE PMPI_Get_count
        ...
        SUBROUTINE PMPIR_Get_count_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(in), TARGET :: status
            ...
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Get_count_f08_large
    ...
    INTERFACE PMPI_Get_elements
        ...
        SUBROUTINE PMPIR_Get_elements_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(in), TARGET :: status
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: count
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Get_elements_f08_large
    ...
    INTERFACE PMPI_Pack
        ...
        SUBROUTINE PMPIR_Pack_f08ts_large(inbuf, incount, datatype, outbuf, outsize, position, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: inbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Pack_f08ts_large
    ...
    INTERFACE PMPI_Pack_external
        ...
        SUBROUTINE PMPIR_Pack_external_f08ts_large(datarep, inbuf, incount, datatype, outbuf, outsize, &
                                                 position, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(inout) :: position
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Pack_external_f08ts_large
    ...
    INTERFACE PMPI_Pack_external_size
        ...
        SUBROUTINE PMPIR_Pack_external_size_f08_large(datarep, incount, datatype, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            CHARACTER(len=*), INTENT(in) :: datarep
            ...
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Pack_external_size_f08_large
    ...
    INTERFACE PMPI_Pack_size
        ...
        SUBROUTINE PMPIR_Pack_size_f08_large(incount, datatype, comm, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: incount
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Pack_size_f08_large
    ...
    INTERFACE PMPI_Status_set_elements
        ...
        SUBROUTINE PMPIR_Status_set_elements_f08_large(status, datatype, count, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Status, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Status), INTENT(inout), TARGET :: status
            ...
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Status_set_elements_f08_large
    ...
    INTERFACE PMPI_Type_contiguous
        ...
        SUBROUTINE PMPIR_Type_contiguous_f08_large(count, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_contiguous_f08_large
    ...
    INTERFACE PMPI_Type_create_darray
        ...
        SUBROUTINE PMPIR_Type_create_darray_f08_large(size, rank, ndims, array_of_gsizes, array_of_distribs, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_darray_f08_large
    ...
    INTERFACE PMPI_Type_create_hindexed
        ...
        SUBROUTINE PMPIR_Type_create_hindexed_f08_large(count, array_of_blocklengths, array_of_displacements, &
                                                      oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_hindexed_f08_large
    ...
    INTERFACE PMPI_Type_create_hindexed_block
        ...
        SUBROUTINE PMPIR_Type_create_hindexed_block_f08_large(count, blocklength, array_of_displacements, &
                                                            oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_hindexed_block_f08_large
    ...
    INTERFACE PMPI_Type_create_hvector
        ...
        SUBROUTINE PMPIR_Type_create_hvector_f08_large(count, blocklength, stride, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_hvector_f08_large
    ...
    INTERFACE PMPI_Type_create_indexed_block
        ...
        SUBROUTINE PMPIR_Type_create_indexed_block_f08_large(count, blocklength, array_of_displacements, &
                                                           oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_indexed_block_f08_large
    ...
    INTERFACE PMPI_Type_create_struct
        ...
        SUBROUTINE PMPIR_Type_create_struct_f08_large(count, array_of_blocklengths, array_of_displacements, &
                                                    array_of_types, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_struct_f08_large
    ...
    INTERFACE PMPI_Type_create_subarray
        ...
        SUBROUTINE PMPIR_Type_create_subarray_f08_large(ndims, array_of_sizes, array_of_subsizes, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_create_subarray_f08_large
    ...
    INTERFACE PMPI_Type_get_contents
        ...
        SUBROUTINE PMPIR_Type_get_contents_f08_large(datatype, max_integers, max_addresses, max_large_counts, &
            ...
            TYPE(MPI_Datatype), INTENT(out) :: array_of_datatypes(max_datatypes)
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_get_contents_f08_large
    ...
    INTERFACE PMPI_Type_get_envelope
        ...
        SUBROUTINE PMPIR_Type_get_envelope_f08_large(datatype, num_integers, num_addresses, num_large_counts, &
            ...
            INTEGER, INTENT(out) :: combiner
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_get_envelope_f08_large
    ...
    INTERFACE PMPI_Type_indexed
        ...
        SUBROUTINE PMPIR_Type_indexed_f08_large(count, array_of_blocklengths, array_of_displacements, oldtype, &
                                              newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_indexed_f08_large
    ...
    INTERFACE PMPI_Type_size
        ...
        SUBROUTINE PMPIR_Type_size_f08_large(datatype, size, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_size_f08_large
    ...
    INTERFACE PMPI_Type_vector
        ...
        SUBROUTINE PMPIR_Type_vector_f08_large(count, blocklength, stride, oldtype, newtype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: count
            ...
            TYPE(MPI_Datatype), INTENT(out) :: newtype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Type_vector_f08_large
    ...
    INTERFACE PMPI_Unpack
        ...
        SUBROUTINE PMPIR_Unpack_f08ts_large(inbuf, insize, position, outbuf, outcount, datatype, comm, &
                                          ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Unpack_f08ts_large
    ...
    INTERFACE PMPI_Unpack_external
        ...
        SUBROUTINE PMPIR_Unpack_external_f08ts_large(datarep, inbuf, insize, position, outbuf, outcount, &
                                                   datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Unpack_external_f08ts_large
    ...
    INTERFACE PMPIX_Delete_error_class
        SUBROUTINE PMPIR_Delete_error_class_f08(errorclass, ierror)
            IMPLICIT NONE
            INTEGER, INTENT(in) :: errorclass
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Delete_error_class_f08
    END INTERFACE PMPIX_Delete_error_class
    
    INTERFACE PMPIX_Delete_error_code
        SUBROUTINE PMPIR_Delete_error_code_f08(errorcode, ierror)
            IMPLICIT NONE
            INTEGER, INTENT(in) :: errorcode
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Delete_error_code_f08
    END INTERFACE PMPIX_Delete_error_code
    
    INTERFACE PMPIX_Delete_error_string
        SUBROUTINE PMPIR_Delete_error_string_f08(errorcode, ierror)
            IMPLICIT NONE
            INTEGER, INTENT(in) :: errorcode
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Delete_error_string_f08
    END INTERFACE PMPIX_Delete_error_string
    ...
    INTERFACE PMPI_Op_create_c
        SUBROUTINE PMPIR_Op_create_f08_large(user_fn, commute, op, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Op
            ...
            TYPE(MPI_Op), INTENT(out) :: op
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Op_create_f08_large
    ...
    INTERFACE PMPI_Bsend
        ...
        SUBROUTINE PMPIR_Bsend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Bsend_f08ts_large
    ...
    INTERFACE PMPI_Bsend_init
        ...
        SUBROUTINE PMPIR_Bsend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Bsend_init_f08ts_large
    ...
    INTERFACE PMPI_Buffer_attach
        ...
        SUBROUTINE PMPIR_Buffer_attach_f08ts_large(buffer, size, ierror)
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buffer
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(in) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Buffer_attach_f08ts_large
    ...
    INTERFACE PMPI_Buffer_detach
        ...
        SUBROUTINE PMPIR_Buffer_detach_f08_large(buffer_addr, size, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(C_PTR), INTENT(out) :: buffer_addr
            INTEGER(KIND=MPI_COUNT_KIND), INTENT(out) :: size
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Buffer_detach_f08_large
    ...
    INTERFACE PMPI_Ibsend
        ...
        SUBROUTINE PMPIR_Ibsend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ibsend_f08ts_large
    ...
    INTERFACE PMPI_Imrecv
        ...
        SUBROUTINE PMPIR_Imrecv_f08ts_large(buf, count, datatype, message, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Message, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Imrecv_f08ts_large
    ...
    INTERFACE PMPI_Irecv
        ...
        SUBROUTINE PMPIR_Irecv_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Irecv_f08ts_large
    ...
    INTERFACE PMPI_Irsend
        ...
        SUBROUTINE PMPIR_Irsend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Irsend_f08ts_large
    ...
    INTERFACE PMPI_Isend
        ...
        SUBROUTINE PMPIR_Isend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Isend_f08ts_large
    ...
    INTERFACE PMPI_Isendrecv
        ...
        SUBROUTINE PMPIR_Isendrecv_f08ts_large(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Isendrecv_f08ts_large
    ...
    INTERFACE PMPI_Isendrecv_replace
        ...
        SUBROUTINE PMPIR_Isendrecv_replace_f08ts_large(buf, count, datatype, dest, sendtag, source, recvtag, &
                                                     comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Isendrecv_replace_f08ts_large
    ...
    INTERFACE PMPI_Issend
        ...
        SUBROUTINE PMPIR_Issend_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Issend_f08ts_large
    ...
    INTERFACE PMPI_Mrecv
        ...
        SUBROUTINE PMPIR_Mrecv_f08ts_large(buf, count, datatype, message, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Message, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Mrecv_f08ts_large
    ...
    INTERFACE PMPI_Recv
        ...
        SUBROUTINE PMPIR_Recv_f08ts_large(buf, count, datatype, source, tag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Recv_f08ts_large
    ...
    INTERFACE PMPI_Recv_init
        ...
        SUBROUTINE PMPIR_Recv_init_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Recv_init_f08ts_large
    ...
    INTERFACE PMPI_Rsend
        ...
        SUBROUTINE PMPIR_Rsend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Rsend_f08ts_large
    ...
    INTERFACE PMPI_Rsend_init
        ...
        SUBROUTINE PMPIR_Rsend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Rsend_init_f08ts_large
    ...
    INTERFACE PMPI_Send
        ...
        SUBROUTINE PMPIR_Send_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Send_f08ts_large
    ...
    INTERFACE PMPI_Send_init
        ...
        SUBROUTINE PMPIR_Send_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Send_init_f08ts_large
    ...
    INTERFACE PMPI_Sendrecv
        ...
        SUBROUTINE PMPIR_Sendrecv_f08ts_large(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, &
                                            recvtype, source, recvtag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Sendrecv_f08ts_large
    ...
    INTERFACE PMPI_Sendrecv_replace
        ...
        SUBROUTINE PMPIR_Sendrecv_replace_f08ts_large(buf, count, datatype, dest, sendtag, source, recvtag, &
                                                    comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Sendrecv_replace_f08ts_large
    ...
    INTERFACE PMPI_Ssend
        ...
        SUBROUTINE PMPIR_Ssend_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ssend_f08ts_large
    ...
    INTERFACE PMPI_Ssend_init
        ...
        SUBROUTINE PMPIR_Ssend_init_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Ssend_init_f08ts_large
    ...
    INTERFACE PMPI_Accumulate
        ...
        SUBROUTINE PMPIR_Accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                              target_disp, target_count, target_datatype, op, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Accumulate_f08ts_large
    ...
    INTERFACE PMPI_Get
        ...
        SUBROUTINE PMPIR_Get_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, target_disp, &
                                       target_count, target_datatype, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Get_f08ts_large
    ...
    INTERFACE PMPI_Get_accumulate
        ...
        SUBROUTINE PMPIR_Get_accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, result_addr, &
                                                  result_count, result_datatype, target_rank, target_disp, &
                                                  target_count, target_datatype, op, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Get_accumulate_f08ts_large
    ...
    INTERFACE PMPI_Put
        ...
        SUBROUTINE PMPIR_Put_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, target_disp, &
                                       target_count, target_datatype, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(in) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Put_f08ts_large
    ...
    INTERFACE PMPI_Raccumulate
        ...
        SUBROUTINE PMPIR_Raccumulate_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                               target_disp, target_count, target_datatype, op, win, request, &
                                               ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Raccumulate_f08ts_large
    ...
    INTERFACE PMPI_Rget
        ...
        SUBROUTINE PMPIR_Rget_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Rget_f08ts_large
    ...
    INTERFACE PMPI_Rget_accumulate
        ...
        SUBROUTINE PMPIR_Rget_accumulate_f08ts_large(origin_addr, origin_count, origin_datatype, result_addr, &
                                                   result_count, result_datatype, target_rank, target_disp, &
                                                   target_count, target_datatype, op, win, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Rget_accumulate_f08ts_large
    ...
    INTERFACE PMPI_Rput
        ...
        SUBROUTINE PMPIR_Rput_f08ts_large(origin_addr, origin_count, origin_datatype, target_rank, &
                                        target_disp, target_count, target_datatype, win, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Win, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND, MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Rput_f08ts_large
    ...
    INTERFACE PMPI_Win_allocate
        ...
        SUBROUTINE PMPIR_Win_allocate_f08_large(size, disp_unit, info, comm, baseptr, win, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Win_allocate_f08_large
    ...
    INTERFACE PMPI_Win_allocate_shared
        ...
        SUBROUTINE PMPIR_Win_allocate_shared_f08_large(size, disp_unit, info, comm, baseptr, win, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Win_allocate_shared_f08_large
    ...
    INTERFACE PMPI_Win_create
        ...
        SUBROUTINE PMPIR_Win_create_f08ts_large(base, size, disp_unit, info, comm, win, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Info, MPI_Comm, MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: base
            ...
            TYPE(MPI_Win), INTENT(out) :: win
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Win_create_f08ts_large
    ...
    INTERFACE PMPI_Win_shared_query
        ...
        SUBROUTINE PMPIR_Win_shared_query_f08_large(win, rank, size, disp_unit, baseptr, ierror)
            USE, intrinsic :: iso_c_binding, ONLY : C_PTR
            USE :: mpi_f08_types, ONLY : MPI_Win
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            IMPLICIT NONE
            ...
            TYPE(C_PTR), INTENT(out) :: baseptr
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Win_shared_query_f08_large
    ...
    INTERFACE PMPIX_Stream_send
        ...
        SUBROUTINE PMPIXR_Stream_send_f08ts_large(buf, count, datatype, dest, tag, comm, source_stream_index, &
                                                dest_stream_index, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            INTEGER, INTENT(in) :: dest_stream_index
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Stream_send_f08ts_large
    ...
    INTERFACE PMPIX_Stream_isend
        ...
        SUBROUTINE PMPIXR_Stream_isend_f08ts_large(buf, count, datatype, dest, tag, comm, source_stream_index, &
                                                 dest_stream_index, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Stream_isend_f08ts_large
    ...
    INTERFACE PMPIX_Stream_recv
        ...
        SUBROUTINE PMPIXR_Stream_recv_f08ts_large(buf, count, datatype, source, tag, comm, &
                                                source_stream_index, dest_stream_index, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Stream_recv_f08ts_large
    ...
    INTERFACE PMPIX_Stream_irecv
        ...
        SUBROUTINE PMPIXR_Stream_irecv_f08ts_large(buf, count, datatype, source, tag, comm, &
                                                 source_stream_index, dest_stream_index, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), ASYNCHRONOUS :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Stream_irecv_f08ts_large
    ...
    INTERFACE PMPIX_Send_enqueue
        ...
        SUBROUTINE PMPIXR_Send_enqueue_f08ts_large(buf, count, datatype, dest, tag, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Send_enqueue_f08ts_large
    ...
    INTERFACE PMPIX_Recv_enqueue
        ...
        SUBROUTINE PMPIXR_Recv_enqueue_f08ts_large(buf, count, datatype, source, tag, comm, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Recv_enqueue_f08ts_large
    ...
    INTERFACE PMPIX_Isend_enqueue
        ...
        SUBROUTINE PMPIXR_Isend_enqueue_f08ts_large(buf, count, datatype, dest, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Isend_enqueue_f08ts_large
    ...
    INTERFACE PMPIX_Irecv_enqueue
        ...
        SUBROUTINE PMPIXR_Irecv_enqueue_f08ts_large(buf, count, datatype, source, tag, comm, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Comm, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..) :: buf
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Irecv_enqueue_f08ts_large
    ...
    INTERFACE PMPIX_Allreduce_enqueue
        ...
        SUBROUTINE PMPIXR_Allreduce_enqueue_f08ts_large(sendbuf, recvbuf, count, datatype, op, comm, ierror)
            USE :: mpi_f08_types, ONLY : MPI_Datatype, MPI_Op, MPI_Comm
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(*), DIMENSION(..), INTENT(in) :: sendbuf
            ...
            TYPE(MPI_Comm), INTENT(in) :: comm
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIXR_Allreduce_enqueue_f08ts_large
    ...
    INTERFACE PMPI_File_iread
        ...
        SUBROUTINE PMPIR_File_iread_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iread_f08ts_large
    ...
    INTERFACE PMPI_File_iread_all
        ...
        SUBROUTINE PMPIR_File_iread_all_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iread_all_f08ts_large
    ...
    INTERFACE PMPI_File_iread_at
        ...
        SUBROUTINE PMPIR_File_iread_at_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iread_at_f08ts_large
    ...
    INTERFACE PMPI_File_iread_at_all
        ...
        SUBROUTINE PMPIR_File_iread_at_all_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iread_at_all_f08ts_large
    ...
    INTERFACE PMPI_File_iread_shared
        ...
        SUBROUTINE PMPIR_File_iread_shared_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iread_shared_f08ts_large
    ...
    INTERFACE PMPI_File_iwrite
        ...
        SUBROUTINE PMPIR_File_iwrite_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iwrite_f08ts_large
    ...
    INTERFACE PMPI_File_iwrite_all
        ...
        SUBROUTINE PMPIR_File_iwrite_all_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iwrite_all_f08ts_large
    ...
    INTERFACE PMPI_File_iwrite_at
        ...
        SUBROUTINE PMPIR_File_iwrite_at_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iwrite_at_f08ts_large
    ...
    INTERFACE PMPI_File_iwrite_at_all
        ...
        SUBROUTINE PMPIR_File_iwrite_at_all_f08ts_large(fh, offset, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iwrite_at_all_f08ts_large
    ...
    INTERFACE PMPI_File_iwrite_shared
        ...
        SUBROUTINE PMPIR_File_iwrite_shared_f08ts_large(fh, buf, count, datatype, request, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Request
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Request), INTENT(out) :: request
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_iwrite_shared_f08ts_large
    ...
    INTERFACE PMPI_File_read
        ...
        SUBROUTINE PMPIR_File_read_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_f08ts_large
    ...
    INTERFACE PMPI_File_read_all
        ...
        SUBROUTINE PMPIR_File_read_all_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_all_f08ts_large
    ...
    INTERFACE PMPI_File_read_all_begin
        ...
        SUBROUTINE PMPIR_File_read_all_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_all_begin_f08ts_large
    ...
    INTERFACE PMPI_File_read_at
        ...
        SUBROUTINE PMPIR_File_read_at_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_at_f08ts_large
    ...
    INTERFACE PMPI_File_read_at_all
        ...
        SUBROUTINE PMPIR_File_read_at_all_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_at_all_f08ts_large
    ...
    INTERFACE PMPI_File_read_at_all_begin
        ...
        SUBROUTINE PMPIR_File_read_at_all_begin_f08ts_large(fh, offset, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_at_all_begin_f08ts_large
    ...
    INTERFACE PMPI_File_read_ordered
        ...
        SUBROUTINE PMPIR_File_read_ordered_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_ordered_f08ts_large
    ...
    INTERFACE PMPI_File_read_ordered_begin
        ...
        SUBROUTINE PMPIR_File_read_ordered_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_ordered_begin_f08ts_large
    ...
    INTERFACE PMPI_File_read_shared
        ...
        SUBROUTINE PMPIR_File_read_shared_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_read_shared_f08ts_large
    ...
    INTERFACE PMPI_File_write
        ...
        SUBROUTINE PMPIR_File_write_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_f08ts_large
    ...
    INTERFACE PMPI_File_write_all
        ...
        SUBROUTINE PMPIR_File_write_all_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_all_f08ts_large
    ...
    INTERFACE PMPI_File_write_all_begin
        ...
        SUBROUTINE PMPIR_File_write_all_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_all_begin_f08ts_large
    ...
    INTERFACE PMPI_File_write_at
        ...
        SUBROUTINE PMPIR_File_write_at_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_at_f08ts_large
    ...
    INTERFACE PMPI_File_write_at_all
        ...
        SUBROUTINE PMPIR_File_write_at_all_f08ts_large(fh, offset, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_at_all_f08ts_large
    ...
    INTERFACE PMPI_File_write_at_all_begin
        ...
        SUBROUTINE PMPIR_File_write_at_all_begin_f08ts_large(fh, offset, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_OFFSET_KIND, MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_at_all_begin_f08ts_large
    ...
    INTERFACE PMPI_File_write_ordered
        ...
        SUBROUTINE PMPIR_File_write_ordered_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_ordered_f08ts_large
    ...
    INTERFACE PMPI_File_write_ordered_begin
        ...
        SUBROUTINE PMPIR_File_write_ordered_begin_f08ts_large(fh, buf, count, datatype, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Datatype), INTENT(in) :: datatype
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_ordered_begin_f08ts_large
    ...
    INTERFACE PMPI_File_write_shared
        ...
        SUBROUTINE PMPIR_File_write_shared_f08ts_large(fh, buf, count, datatype, status, ierror)
            USE :: mpi_f08_types, ONLY : MPI_File, MPI_Datatype, MPI_Status
            USE :: mpi_f08_compile_constants, ONLY : MPI_COUNT_KIND
            IMPLICIT NONE
            TYPE(MPI_File), INTENT(in) :: fh
            ...
            TYPE(MPI_Status), INTENT(out), TARGET :: status
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_File_write_shared_f08ts_large
    ...
    INTERFACE PMPI_Register_datarep_c
        SUBROUTINE PMPIR_Register_datarep_f08_large(datarep, read_conversion_fn, write_conversion_fn, &
                                                  dtype_file_extent_fn, extra_state, ierror)
            USE :: mpi_f08_compile_constants, ONLY : MPI_ADDRESS_KIND
            ...
            INTEGER(KIND=MPI_ADDRESS_KIND), INTENT(in) :: extra_state
            INTEGER, OPTIONAL, INTENT(out) :: ierror
        END SUBROUTINE PMPIR_Register_datarep_f08_large
